...
{
	// GoRogue AStar, Heuristic/Weight added, using nudging Tiebreaker instead of direction ordering, optimized for dynamic allocation of nodes, using separate array for closed set.
	public class GR_H_W_T_D_Array
	{
		...
		/// </param>
		public GR_H_W_T_D_Array(IMapView<bool> walkabilityMap, Distance distanceMeasurement, Func<Coord, Coord, double> heuristic = null, IMapView<double> weights = null)
		{
