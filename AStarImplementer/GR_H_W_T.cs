...
namespace AStarImplementer
{
	...
	internal class GRAStarNode : FastPriorityQueueNode
	{
		...
		public GRAStarNode Parent;
		// (Known) distance from start to this node, by shortest known path

		public GRAStarNode(Coord position, GRAStarNode parent = null)
		{
			Parent = parent;
			Position = position;
			Closed = false;
	...
	// GoRogue AStar, Heuristic/Weight added, using nudging Tiebreaker instead of direction ordering
	public class GR_H_W_T
	{
		...
		/// </param>
		public GR_H_W_T(IMapView<bool> walkabilityMap, Distance distanceMeasurement, Func<Coord, Coord, double> heuristic = null, IMapView<double> weights = null)
		{
